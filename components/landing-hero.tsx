      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          <div className="relative">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-amber-300 via-amber-400 to-amber-600 flex items-center justify-center shadow-2xl shadow-amber-500/30">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold text-amber-50 mb-4 tracking-tight">
            廟務雲
            <span className="text-2xl md:text-3xl font-normal text-amber-200/80 mt-2 block">
              寺廟數位管理平台
            </span>
          </h1>
          ...
          <p className="text-lg text-amber-200/70 mb-10 max-w-2xl mx-auto">
        ...
        >
          <SignInButton>
            <button className="group relative px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 rounded-xl text-stone-900 font-bold text-lg shadow-xl shadow-amber-500/30 hover:shadow-amber-500/50 transition-all hover:scale-105">
              免費開始使用
            </button>
          </SignInButton>
          <button className="px-8 py-4 border-2 border-amber-400/50 rounded-xl text-amber-100 font-medium text-lg hover:bg-amber-400/10 transition-all">
            了解更多
          </button>
        </motion.div>
